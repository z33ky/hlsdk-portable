...
BOOL CCivilian::CanHeal( void )
{
	...
	if ( (m_healTime > gpGlobals->time) || !m_hTargetEnt || (m_hTargetEnt->pev->health > (m_hTargetEnt->pev->max_health * 0.5)) )
		return FALSE;
...
const char *CDeadCivilian::m_szPoses[] = { "lying_on_back", "lying_on_stomach", "dead_sitting", "dead_hang", "dead_table1", "dead_table2", "dead_table3" };
