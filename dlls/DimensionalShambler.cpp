		...
		if (HasConditions(bits_COND_SEE_ENEMY))
		{
			...
			for (y =-PI; y < PI; y += PI/6)
			{
				...
				if ( bUp && bDown )
				{
					...
					CBaseEntity* pWarpOut = CBaseEntity::Create("env_warpball",myOrig+Vector(0,0,36),Vector(0,0,0),edict());
					...
					CBaseEntity* pWarpIn = CBaseEntity::Create("env_warpball",pev->origin+Vector(0,0,36),Vector(0,0,0),edict());
