...
const char *CDeadSirHenry::m_szPoses[] = { "lying_on_back", "lying_on_stomach", "dead_sitting", "dead_hang", "dead_table1", "dead_table2", "dead_table3" };
...
void CSittingSirHenry :: Spawn( )
{
	...
	SetThink (&CSittingSirHenry :: SittingThink);
	SetNextThink( 0.1 );
