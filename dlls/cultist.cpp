...
void CCultist :: SetActivity ( Activity NewActivity )
{
	...
	case ACT_MELEE_ATTACK1:
		...
		if ((m_hEnemy) && (m_hEnemy->pev->maxs.z < 36) && FBitSet( pev->weapons, CULTIST_KNIFE))
		{
			m_fStanding = 0;
		}
...
const char *CDeadCultist::m_szPoses[] = { "deadstomach", "deadside", "deadsitting" };
