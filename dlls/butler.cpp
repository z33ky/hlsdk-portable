...
const char *CDeadButler::m_szPoses[] = { "lying_on_back", "lying_on_stomach", "dead_sitting", "dead_hang", "dead_table1", "dead_table2", "dead_table3" };
...
void CSittingButler :: Spawn( )
{
	...
	SetThink (&CSittingButler :: SittingThink);
	SetNextThink( 0.1 );
