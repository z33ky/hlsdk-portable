...
//	wrect_t rc_zero;
	...
	rc = *m_prc2;
	rc.top  += m_iHeight * ((100-(Q_min(100,m_iSan))) * 0.01f);	// sanity can go from 0 to 100 so * 0.01 goes from 0 to 1

//	rc_zero = *m_prc1;
//	rc_zero.top  += m_iHeight * ((Q_min(100,m_iSan)) * 0.01f);	// sanity can go from 0 to 100 so * 0.01 goes from 0 to 1
